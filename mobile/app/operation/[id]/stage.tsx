...
const styles = StyleSheet.create({
  ...
  warningTitle: { color: colors.amber, fontSize: 16, fontWeight: "800" },
  ...
  checkMark: { fontSize: 9, fontWeight: "900" },
  ...
  requirementCount: { color: colors.surface, fontSize: 13, fontWeight: "900" },
  missingRequirements: { color: "#f0cfa2", fontSize: 11, lineHeight: 16 },
