...
- **Felipe** — ITA (Engenharia). Lida com o lado comercial, prospecção e relacionamento. Prefere comunicação por X (Twitter). Não tem medo de abordagem fria.
...
Projetos e dados identificáveis de clientes não ficam neste repositório público.
Cada projeto contratado usa um repositório privado próprio.
...
- `contexto/SALES.md` — resumo público anonimizado do funil
