...
5. `.Codex/pending.md` — pendências locais entre sessões, quando existir
...
Projetos e dados de clientes ficam em repositórios próprios e privados, nunca
aqui. Leia o `AGENTS.md` do repositório correspondente antes de trabalhar em um
projeto contratado.
...
- Projetos e dados identificáveis de clientes não pertencem a este repositório.
- Pendências locais: ver `.Codex/pending.md`, quando existir.
...
Editar `.Codex/pending.md` e trocar `- [ ]` por `- [x]`.
