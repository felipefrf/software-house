...
Sistema de prospecção de médicos e advogados em Salvador (BA) para venda de sites, apps, sistemas de agendamento e automação de WhatsApp. Ticket-alvo: R$5k.

Todo o diretório `state/` é local e ignorado pelo Git porque contém dados de
pré-clientes.
...
- ✅ Não mentir sobre competidores ou resultados
